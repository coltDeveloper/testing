...
const ClassSchedule = () => {
    ...
    subjects.forEach(subjectItem => {
      ...
      schedules.forEach(schedule => {
        ...
        datesForDay.forEach(date => {
          ...
          startTimeDate.setHours(parseInt(hours), parseInt(minutes), parseInt(seconds));
  ...
  const timeZone = [7, 8, 9, 10, 11, 12, 13, 2, 3, 4, 5, 6, 7, 8, 9, 10];
  return (
    <>
        ...
        <div className="timetable">
          ...
          <table className="table table-bordered">
            ...
            <tbody>
              {timeZone.map((time) => (
                <tr key={time}>
                  <td className="clocK_time text-primary">{setAMPM(time)}</td>
                      ...
                      >
                        {matchingClass ? (
                          <div className="d-flex flex-column">
                            ...
                            <span>{setAMPM(matchingClass.time)}</span>
                          </div>
                        ) : (
                          "-"
                        )}
